...
export default function AddWorkforceGroupPage() {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      const newGroup = addWorkforceGroup({
      ...
      pushToast({ title: "Success", description: `Workforce group "${newGroup.name}" has been added successfully.` })
      router.push("/admin/workforce-groups")
    } catch (error) {
      pushToast({ title: "Error", description: "Failed to add workforce group. Please try again." })
    } finally {
          ...
          <Card>
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-3 pt-4 border-t">
                ...
                >
                  {isSubmitting ? "Creating..." : "Create Workforce Group"}
                </button>
                <Link href="/admin/workforce-groups" className="ph5-button-secondary">
                  Cancel
                </Link>
